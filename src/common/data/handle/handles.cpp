...
data::TileHandle::TileHandle(const ::id& id, const definition::Tile& tile_def) : _id(id) {
    ...
    if (holds_alternative<str>(tile_def.model)) {
        _model_type = ModelType::Custom;
        _model_path = get<str>(tile_def.model);
    }
    else {
    ...
    switch (tile_def.collision) {
        case definition::CollisionType::none:   _collision_type = CollisionType::None;  break;
        case definition::CollisionType::block:  _collision_type = CollisionType::Block; break;
        default:                                _collision_type = CollisionType::None;  break;
    }
}
...
data::TileHandle::CollisionType data::TileHandle::collision_type() const { return _collision_type; }
